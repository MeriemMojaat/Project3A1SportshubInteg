...
public class ShowCategoryCoach {
...
// Other imports...
    ...
    private void handlelistworkouts(ActionEvent event, int idCategory) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/ShowWorkoutsCoach.fxml"));
            Parent root = loader.load();

            ShowWorkoutsCoach showWorkoutsController = loader.getController();
