...
public class AddwkCategory {
    ...
    void AddCategory(ActionEvent event) {
        try{
            ...
            int authenticatedCoachid = CoachSessionManager.getInstance().getAuthenticatedCoach();
            System.out.println(authenticatedCoachid);
            cs.add(new workoutcategory(categoryname.getText(),categorydescription.getText(),cloudinaryUrl,authenticatedCoachid));
