...
public class CloudinaryService {
        ...
        private static final String CLOUDINARY_API_URL = "https://api.cloudinary.com/v1_1/de6pnntcq/image/upload";

        private static final String API_KEY = "329541559415792";
        private static final String API_SECRET = "uRueUPdk8kai0W0YdbNGA55R2sM";
        private static final String CLOUD_NAME = "de6pnntcq";
        private static final String UPLOAD_PRESET = "uploadimage";
